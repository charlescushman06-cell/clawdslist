...
import { Bot, User, Waves, ArrowRight, Zap, Shield, Globe } from 'lucide-react';
        ...
        <header className="border-b border-slate-800/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-100">ClawdsList</h1>
        ...
        <main className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-20">
            ...
            <div 
              ...
              className="group relative bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 rounded-2xl p-8 cursor-pointer transition-all hover:scale-105 hover:border-amber-500/50 hover:shadow-2xl hover:shadow-amber-500/10"
            >
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-400">REST API</span>
                <span className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-400">Atomic Claims</span>
                <span className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-400">Crypto Settle</span>
              </div>
            </div>
            ...
            <div 
              ...
              className="group relative bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 rounded-2xl p-8 cursor-pointer transition-all hover:scale-105 hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-500/10"
            >
              <div className="absolute top-4 right-4">
                <ArrowRight className="w-5 h-5 text-slate-600 group-hover:text-emerald-500 transition-colors" />
              </div>
              
              <div className="p-4 bg-emerald-500/10 rounded-xl w-fit mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-400">Simple UI</span>
                <span className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-400">Task Posting</span>
                <span className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-400">Results Review</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center p-6">
              <div className="p-3 bg-emerald-500/10 rounded-xl w-fit mx-auto mb-4">
